#' @title Create a simple AQUARIUS Time-Series API client.
#'
...
#' @name timeseriesClient_disconnect
#'
NULL
timeseriesClient$methods(
  disconnect = function() {
...
#'
#' @name timeseriesClient_configureProxy
#' @description This method configures the R proxy to route everything through Fiddler if it is running
#' @return None
#' @examples
#' \dontrun{
...
#'
#' @name timeseriesClient_isVersionLessThan
...
#'
#' @name timeseriesClient_getTimeSeriesUniqueId
...
#'
#' @name timeseriesClient_getLocationIdentifier
#' @param timeSeriesIdentifier A time-series identifier in \<Parameter\>.\<Label\>\@\<LocationIdentifier\> syntax
...
#'
#' @name timeseriesClient_parseIso8601
...
#'
#' @name timeseriesClient_formatIso8601
...
#'
#' @name timeseriesClient_getUtcOffsetText
...
#'
#' @name timeseriesClient_getLocationData
NULL
timeseriesClient$methods(
...
#'
#' @name timeseriesClient_getRatings
...
#'
#' @name timeseriesClient_getRatingModelOutputValues
...
#'
#' @name timeseriesClient_getFieldVisits
#' @param locationIdentifier Optional LocationIdentifier filter
#' @param queryFrom Optional QueryFrom filter
#' @param queryTo Optional QueryTo filter
...
#'
#' @name timeseriesClient_getMetadataChangeTransactionList
...
#'
#' @name timeseriesClient_toJSV
#' @description Converts vectors or named lists to JSV. Everything else is left unmodified.
#'
...
#'
#' @name timeseriesClient_getTimeSeriesDescriptions
...
#'
#' @name timeseriesClient_getTimeSeriesData
...
#'
#' @name timeseriesClient_getTimeSeriesCorrectedData
#' @param timeSeriesIdentifier The time-series identifier or unique ID
...
#'
#' @name timeseriesClient_uploadExternalReport
...
#'
#' @name timeseriesClient_getReportList
NULL
timeseriesClient$methods(
...
#' Deletes a report
#'
#' @name timeseriesClient_deleteReport
NULL
timeseriesClient$methods(
...
#'
#'
#' @name timeseriesClient_sendBatchRequests
